 ...
 */
metadata {
	definition(name: "Z-Wave Switch Secure As Smoke Detector", namespace: "kfcpub", author: "kfcpub", mnmn: "SmartThings", vid: "generic-smoke", ocfDeviceType: "x.com.st.d.sensor.smoke") {
    //ocfDeviceType: "oic.d.switch",
    //runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		capability "Sensor"
...
def zwaveEvent(physicalgraph.zwave.commands.basicv1.BasicReport cmd) {
	...
	createEvent(name: "smoke", value: cmd.value ? "detected" : "clear", descriptionText: "$device.displayName " + (cmd.value ? "detected smoke" : "is clear"))
}
